...
public class GetDataSubsetFromInputFileTests extends TestBase {
    ...
    public void retrieveColumnRangeFromInputFileTest() {
        ...
        print(utility.getColumnRangeFromInputFile2DArray(2, 4));
        assertEquals("[ Row 1 Col 2,  Row 1 Col 3,  Row 1 Col 4,  Row 2 Col 2,  Row 2 Col 3,  Row 2 Col 4,  Row 3 Col 2,  Row 3 Col 3,  Row 3 Col 4,  Row 4 Col 2,  Row 4 Col 3,  Row 4 Col 4,  Row 5 Col 2,  Row 5 Col 3,  Row 5 Col 4,  Row 6 Col 2,  Row 6 Col 3,  Row 6 Col 4,  Row 7 Col 2,  Row 7 Col 3,  Row 7 Col 4]",
                utility.getColumnRangeFromInputFile2DArray(2,4).toString());
    }
